...
if __name__ == '__main__':
    ...
    print(
        ...
        f'Время выполнения c декоратором: {timeit.timeit("rec_fib", setup="from __main__ import rec_fib")} \n',
        ...
        f'Время выполнения с декоратором: {timeit.timeit("rec_factorial", setup="from __main__ import rec_factorial")} \n',
